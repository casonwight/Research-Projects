---
title: "Stat 535 Application Portfolio"
...
This project is intended as a portfolio of various applications of linear models. A linear model is always of the form $\mathbf{y=x\beta+\epsilon}$. Each application is a special case of this form of model. The five sections of this report include the following analyses:
...
# Reading in the data
fire <- read.csv("C:/Users/cason/Desktop/Classes/Assignments/Stat 535/Application Portfolio/fires.csv", header = TRUE)$Total.Acres
```
...
hotChocolate <- read.csv(header = TRUE, file = "C:/Users/cason/Desktop/Classes/Assignments/Stat 535/Application Portfolio/HotChocolate.csv")
...
# Reading in the data
grades <- read.csv("C:/Users/cason/Desktop/Classes/Assignments/Stat 535/Application Portfolio/grades.csv")
```
